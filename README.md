...
This web app: 
Is a Discover App for exploring different types of breeds of dogs.
...
Working with APIs still not used to it and took a little extra time to understand. Working between the lab and the project to better understand APIs. 
